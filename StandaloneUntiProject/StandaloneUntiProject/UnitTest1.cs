...
namespace PartialTestCheck
{
    ...
    public class ValidityTest
    {
        ...
        {
            Assert.AreEqual(null, dll.FindCountry("000111111111"));
        }
        [TestMethod]
        ...
        public void CalculateCost_Books_6Percent_VAT()
        {
            ...
            Product book = new Product("9781111111111", "Ελλάδα", 10, "Βιβλία", 100.0, 0);
            double tax = 0, disc = 0, final = 0;
        ...
        {
            Assert.AreEqual(false, dll.ProductsToOrder(products2, 4, ref tempOrder));
        }
        [TestMethod]
